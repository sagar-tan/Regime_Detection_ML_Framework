# BTC_Framework/run_regime_specific_strategy_BTC.py
# Walk-forward backtest for BTC-USD REGIME-SPECIFIC STRATEGY
...
logger = setup_logger("walk_forward_engine_regime_specific_BTC", log_file="walk_forward_engine_regime_specific_BTC.log")
...
def walk_forward_backtest(
    ...
    # Save results with REGIME_SPECIFIC suffix
    signals_df = pd.DataFrame(signals).set_index("Date")
    equity_df = pd.DataFrame(equity).set_index("Date")

    signals_out = RESULTS_DIR / f"signals_regime_specific_BTC.csv"
    equity_out = RESULTS_DIR / f"equity_curve_regime_specific_BTC.csv"
    log_out = RESULTS_DIR / f"backtest_log_regime_specific_BTC.json"
    ...
    trades_out = RESULTS_DIR / f"trades_regime_specific_BTC.csv"
...
if __name__ == "__main__":
    logger.info("===== WALK-FORWARD BACKTEST ENGINE (REGIME-SPECIFIC STRATEGY - BTC) STARTED =====")
    ...
    logger.info("===== WALK-FORWARD BACKTEST ENGINE (REGIME-SPECIFIC STRATEGY - BTC) FINISHED =====")

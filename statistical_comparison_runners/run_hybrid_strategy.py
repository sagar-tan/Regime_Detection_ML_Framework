# statistical_comparison_runners/run_hybrid_strategy.py
# Modified walk_forward_engine.py for HYBRID STRATEGY
# This script generates signals_hybrid.csv for statistical comparison
...
logger = setup_logger("walk_forward_engine_hybrid", log_file="walk_forward_engine_hybrid.log")
...
# Strategy mode: HYBRID (for statistical comparison)
...
def walk_forward_backtest(
    ...
    trades_out = RESULTS_DIR / f"trades_hybrid.csv"
...
if __name__ == "__main__":
    logger.info("===== WALK-FORWARD BACKTEST ENGINE (HYBRID STRATEGY) STARTED =====")
    ...
    logger.info("===== WALK-FORWARD BACKTEST ENGINE (HYBRID STRATEGY) FINISHED =====")

# statistical_comparison_runners/run_regime_specific_strategy.py
# Modified walk_forward_engine.py for REGIME-SPECIFIC STRATEGY
# This script generates signals_regime_specific.csv for statistical comparison
...
logger = setup_logger("walk_forward_engine_regime_specific", log_file="walk_forward_engine_regime_specific.log")
...
# Strategy mode: REGIME-SPECIFIC (for statistical comparison)
...
def walk_forward_backtest(
    ...
    trades_out = RESULTS_DIR / f"trades_regime_specific.csv"
...
if __name__ == "__main__":
    logger.info("===== WALK-FORWARD BACKTEST ENGINE (REGIME-SPECIFIC STRATEGY) STARTED =====")
    ...
    logger.info("===== WALK-FORWARD BACKTEST ENGINE (REGIME-SPECIFIC STRATEGY) FINISHED =====")
